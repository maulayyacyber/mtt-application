...
<div class="bg-color-light">
    <div class="container content-sm">
        ...
        <div class="row" style="text-align: center;margin-top: 20px">
            <button class="btn-u btn-u-sea rounded" id="load_more_gallery" data-val = "0">More album <img style="display: none" id="loader" src="<?php echo base_url('resources/images/loader.svg') ?>" style="width: 5px;height: 5px"></button>
        </div>
    </div>
</div>
<!--=== End News Block ===-->