                        ...
                        <table class="row note">
                            <tr>
                                <td class="wrapper last">
                                    <h4>SELAMAT AKUN ANDA BERHASIL DI AKTIFKAN</h4>
                                    <p>
                                        Hallo, <?php echo $nama ?>, Akun Anda Berhasil diaktifkan, Silahkan login member menggunakan email dan password  Anda!
                                    </p>
                                    <!-- END: Note Panel -->
                                </td>
                            </tr>
