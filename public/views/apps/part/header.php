...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?php echo base_url() ?>apps/dashboard/" class="logo">
            ...
            <span class="logo-mini" style="font-size: 15px"><b>Apps</b> MTT</span>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo base_url() ?>resources/images/avatar/<?php echo $this->session->userdata('apps_foto') ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs"><?php echo $this->session->userdata('apps_nama') ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?php echo $this->session->userdata('apps_nama') ?>
                                    <small>@<?php echo $this->session->userdata('apps_username') ?></small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
